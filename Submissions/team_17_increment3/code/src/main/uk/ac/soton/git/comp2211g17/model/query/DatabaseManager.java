...
import uk.ac.soton.git.comp2211g17.model.query.async.AsyncQueryScheduler;
...
public class DatabaseManager {
    ...
    public final AsyncQueryScheduler scheduler = new AsyncQueryScheduler();
	public final ObjectProperty<Condition> bounceCondition = new SimpleObjectProperty<>(SRV.PAGESVIEWED.le((short) 1));
